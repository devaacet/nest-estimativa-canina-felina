...
export class UpdateUserDto {
  ...
  @ValidateIf((o: UpdateUserDto) => o.role === UserRole.CLIENT, {
  ...
  @ApiProperty({ description: 'Ativar usuário' })
  @IsBoolean({ message: 'Ativar usuário deve ser um verdadeiro ou falso' })
  active: boolean;
